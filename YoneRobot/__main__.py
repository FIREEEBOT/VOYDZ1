...
PM_START_TEXT = """
ʜᴇʟʟᴏ [✨](https://telegra.ph/file/667bd9a4c86e01cb34b62.jpg, ɪᴍ Voydz ᴀ ʜɪɢʜʏ ᴀᴅᴠᴀɴᴄᴇᴅ ʙᴏᴛ ᴡɪᴛʜ ʟᴏᴛꜱ ᴏꜰ ᴀᴍᴀᴢɪɴɢ ᴛᴏᴏʟꜱ.
    ...
    if query.data == "yone_":
        query.message.edit_text(
            text=""" ℹ️ I'm *Voydz*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \nHere is the [💾Want Repository](https://t.me/ESdeathnet).
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..✨ I'm *VOYDZ*
                 \nHere is the [Source Code](https://t.me/ESdeathnet) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
